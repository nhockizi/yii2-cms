...
use yii\helpers\Url;
use nhockizi\cms\assets\AdminAsset;
...
<head>
    ...
    <?= Html::csrfMetaTags() ?>
    <title><?= Yii::t('nhockizi_cms', 'Control Panel') ?> - <?= Html::encode($this->title) ?></title>
    ...
    <div class="container">
        <div class="wrapper">
            <div class="header">
                ...
                <div class="nav">
                    <a href="<?= Yii::$app->homeUrl ?>" class="pull-left"><i class="glyphicon glyphicon-home"></i> <?= Yii::t('nhockizi_cms', 'Open site') ?></a>
                    <a href="<?= Url::to(['/admin/sign/out']) ?>" class="pull-right"><i class="glyphicon glyphicon-log-out"></i> <?= Yii::t('nhockizi_cms', 'Logout') ?></a>
                </div>
            </div>
            <div class="main">
