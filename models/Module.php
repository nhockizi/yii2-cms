...
class Module extends \nhockizi\cms\components\ActiveRecord
{
    ...
    {
        return [
            'name' => Yii::t('nhockizi', 'Name'),
            'class' => Yii::t('nhockizi', 'Class'),
            'title' => Yii::t('nhockizi', 'Title'),
            'icon' => Yii::t('nhockizi', 'Icon'),
            'order_num' => Yii::t('nhockizi', 'Order'),
        ];
    }
    ...
    public function checkExists($attribute)
    {
        if(!class_exists($this->$attribute)){
            $this->addError($attribute, Yii::t('nhockizi', 'Class does not exist'));
        }
    }
