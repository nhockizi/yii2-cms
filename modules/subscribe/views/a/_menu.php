...
<ul class="nav nav-pills">
    <li <?= ($action === 'index') ? 'class="active"' : '' ?>>
        <a href="<?= Url::to(['/admin/'.$module]) ?>"><?= Yii::t('nhockizi_cms/subscribe', 'Subscribers') ?></a>
    </li>
    <li <?= ($action === 'create') ? 'class="active"' : '' ?>>
        <a href="<?= Url::to(['/admin/'.$module.'/a/create']) ?>">
        <?= Yii::t('nhockizi_cms/subscribe', 'Create subscribe') ?>
        </a>
    </li>
    <li <?= ($action === 'history') ? 'class="active"' : '' ?>>
        <a href="<?= $historyUrl ?>">
            ...
            <?php endif; ?>
            <?= Yii::t('nhockizi_cms/subscribe', 'History') ?>
        </a>
    </li>
</ul>
<br/>
