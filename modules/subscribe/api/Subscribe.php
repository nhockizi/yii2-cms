<?php
namespace nhockizi\cms\modules\subscribe\api;
 ...
 * @package nhockizi\cms\modules\subscribe\api
 *
...
class Subscribe extends \nhockizi\cms\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        echo Html::submitButton(Yii::t('nhockizi_cms/subscribe/api', 'Subscribe'), ['class' => 'btn btn-primary', 'id' => 'subscriber-send']);
