<?php
namespace nhockizi\cms\modules\guestbook\api;
...
use nhockizi\cms\modules\guestbook\models\Guestbook as GuestbookModel;
use nhockizi\cms\widgets\ReCaptcha;
...
class Guestbook extends \nhockizi\cms\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        echo Html::submitButton(Yii::t('nhockizi_cms', 'Send'), ['class' => 'btn btn-primary']);
        ActiveForm::end();
