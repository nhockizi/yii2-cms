<?php
namespace nhockizi\cms\modules\text\controllers;
...
class AController extends Controller
{
    ...
    public function actionCreate($slug = null)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('nhockizi_cms/text', 'Text created'));
    ...
    public function actionEdit($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    $this->flash('success', Yii::t('nhockizi_cms/text', 'Text updated'));
                }
                else{
    ...
    public function actionDelete($id)
    {
        ...
        return $this->formatResponse(Yii::t('nhockizi_cms/text', 'Text deleted'));
    }
}