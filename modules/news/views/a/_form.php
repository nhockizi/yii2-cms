...
<?php if($this->context->module->settings['enableThumb']) : ?>
    <?php if($model->image) : ?>
        ...
        <a href="<?= Url::to(['/admin/'.$module.'/a/clear-image', 'id' => $model->news_id]) ?>" class="text-danger confirm-delete" title="<?= Yii::t('nhockizi_cms', 'Clear image')?>"><?= Yii::t('nhockizi_cms', 'Clear image')?></a>
    <?php endif; ?>
