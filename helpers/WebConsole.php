<?php
namespace nhockizi\cms\helpers;
...
class WebConsole
{
    ...
    public static function migrate()
    {
        ...
        self::console()->runAction('migrate', ['migrationPath' => '@cms/migrations/', 'migrationTable' => Yii::$app->getDb()->tablePrefix.'migration', 'interactive' => false]);
