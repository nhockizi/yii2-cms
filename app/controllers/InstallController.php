...
class InstallController extends \yii\web\Controller
{
    ...
    public function actionStep1()
    {
        echo 1;die;
        if($this->adminInstalled){
            return $this->redirect($this->shopInstalled ? ['/'] : ['/install/step4']);
        }
    ...
    public function actionStep2()
    {
        ...
        return $this->render('step2', ['model' => $configForm]);
    }
    ...
    public function actionStep3()
    {
        ...
        Yii::$app->session->setFlash(InstallForm::RETURN_URL_KEY, '/install/step4');

        return $this->render('step3', ['model' => $installForm]);
    }
    ...
    public function actionStep4()
    {
        ...
        return $this->render('step4', ['result' => $result]);
    }
